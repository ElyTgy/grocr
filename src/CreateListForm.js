...
const cuisineLabels = ['african', 'chinese', 'japanese', 'korean', 'vietnamnese', 'thai',
'indian', 'british', 'irish', 'french', 'italian', 'mexican', 
'spanish','middle eastern', 'jewish', 'american', 'cajun', 'southern', 
'greek', 'german', 'nordic', 'eastern european', 'caribbean', 'latin american'] //optional
...
export default class CreateListForm extends Component{
    constructor(props){
        ...
        this.state = {
            listName:'',
            diet: null,
            health:Object.assign({}, ...cuisineLabels.map((x)=>({[x]:false}))),
            mealType:null,
            items: []
        }
                ...
                <form className="ml-5 flex flex-col">
                    ...
                    <div className="mb-10">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            {cuisineLabels.map(label=>{return <Checkbox name={label}/>})}
                        </div>
                    </div>
